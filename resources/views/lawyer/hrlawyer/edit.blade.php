                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="" style="text-align:end">
                                @if($data->image==null)
                                 <img width="250px" height="250px" src="https://dlegal.easycoder24.com/uploads/custom-images/lawyer-2021-09-15-10-06-32-2203.jpg" class="img-fluid" />
                                @else
                                 <img width="250px" height="250px" src="{{ asset('uploads/lawyer-images/'.$data->image) }}" class="img-fluid" />
                                @endif
...
<div class="row">
    <div class="col-12">
        <div class=" mb-4">
            <form id="myForm" action="{{route('lawyer.hrlawyer.update',$data->id)}}" method="post" enctype="multipart/form-data" class="mt-4">
                    @csrf
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" value="{{ $data->date_of_joining }}" name="date_of_joining" class="form-control w-75" id="date_of_joining" >
                                                </div>
                                            </div>
                                                ...
                                                <div class="border p-3">
                                                    ...
                                                    <div class="d-flex form-group justify-content-between">
                                                       ...
                                                       <input type="file" name="image" value="{{ $data->image }}"
                                                            class="form-control w-65 p-1" id="image"
                                                    ...
                                                    <div class="d-flex form-group justify-content-between">
                                                         <label for="name"
                                                            ...
                                                            class="form-control mr-2 col-form-label font-weight-bold text-dark">Result</label>
                                                             <label for="name"
                                                            class="form-control mr-2 col-form-label font-weight-bold text-dark">Subject</label>
                                                             <label for="name"
