                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" id="h_chamber_title" value="{{ $data->h_chamber_title }}" name="h_chamber_title" id="h_chamber_title" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input id="h_chamber_title_one" value="{{ $data->h_chamber_title_one }}" type="text" name="h_chamber_title_one" id="h_chamber_title_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input id="h_chamber_line_one" value="{{ $data->h_chamber_line_one }}" type="text" name="h_chamber_line_one" id="h_chamber_line_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_line_two }}" id="h_chamber_line_two" name="h_chamber_line_two" id="h_chamber_line_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_line_three }}" id="h_chamber_line_three" name="h_chamber_line_three" id="h_chamber_line_three" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_address_title_one }}" id="h_chamber_address_title_one" name="h_chamber_address_title_one" id="h_chamber_address_title_one" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_address_line_one }}" id="h_chamber_address_line_one" name="h_chamber_address_line_one" id="h_chamber_address_line_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_address_line_two }}" id="h_chamber_address_line_two" name="h_chamber_address_line_two" id="h_chamber_address_line_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_address_title_two }}" id="h_chamber_address_title_two" name="h_chamber_address_title_two" id="h_chamber_address_title_two" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_address_title_two_line_one }}" id="h_chamber_address_title_two_line_one" name="h_chamber_address_title_two_line_one" id="h_chamber_address_title_two_line_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_address_title_two_line_two }}" id="h_chamber_address_title_two_line_two" name="h_chamber_address_title_two_line_two" id="h_chamber_address_title_two_line_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_cell_one }}" id="h_chamber_cell_one" name="h_chamber_cell_one" id="h_chamber_cell_one" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="text" value="{{ $data->h_chamber_cell_two }}" id="h_chamber_cell_two" name="h_chamber_cell_two" id="h_chamber_cell_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="email" value="{{ $data->h_chamber_email_one }}" id="h_chamber_email_one" name="h_chamber_email_one" id="h_chamber_email_one" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input type="email" value="{{ $data->h_chamber_email_two }}" id="h_chamber_email_two" name="h_chamber_email_two" id="h_chamber_email_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="case-info-section section">
                                        <div class="d-flex justify-content-between">
                                           ...
                                           <label class="container-checkbox">Active
                                                <input type="checkbox" name="ch_status" value="2" {{ $data->ch_status==2 ? 'checked':'' }}>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_name }}" type="text" id="h_lawyer_name" name="h_lawyer_name" id="h_lawyer_name" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_degree }}" id="h_lawyer_degree" type="text" name="h_lawyer_degree" id="h_lawyer_degree" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_deg_one }}" id="h_lawyer_deg_one" type="text" name="h_lawyer_deg_one" id="h_lawyer_deg_one" class="form-control valid" required>
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_deg_two }}" type="text" id="h_lawyer_deg_two" name="h_lawyer_deg_two" id="h_lawyer_deg_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_court_office }}" type="text" id="h_lawyer_court_office" name="h_lawyer_court_office" id="h_lawyer_court_office" class="form-control valid" required>
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_court_office_one }}" type="text" id="h_lawyer_court_office_one" name="h_lawyer_court_office_one" id="h_lawyer_court_office_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_cell }}" type="text" id="h_lawyer_cell" name="h_lawyer_cell" id="h_lawyer_cell" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_email }}" type="text" id="h_lawyer_email" name="h_lawyer_email" id="h_lawyer_email" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_address_title_one }}" type="text" id="h_lawyer_address_title_one" name="h_lawyer_address_title_one" id="h_lawyer_address_title_one" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_address_line_one }}" type="text" id="h_lawyer_address_line_one" name="h_lawyer_address_line_one" id="h_lawyer_address_line_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_address_line_two }}" type="text" id="h_lawyer_address_line_two" name="h_lawyer_address_line_two" id="h_lawyer_address_line_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_address_title_two }}" type="text" id="h_lawyer_address_title_two" name="h_lawyer_address_title_two" id="h_lawyer_address_title_two" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_address_title_two_line_one }}" type="text" id="h_lawyer_address_title_two_line_one" name="h_lawyer_address_title_two_line_one" id="h_lawyer_address_title_two_line_one" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_address_title_two_line_two }}" type="text" id="h_lawyer_address_title_two_line_two" name="h_lawyer_address_title_two_line_two" id="h_lawyer_address_title_two_line_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_cell_one }}" type="text" id="h_lawyer_cell_one" name="h_lawyer_cell_one" id="h_lawyer_cell_one" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_cell_two }}" type="text" id="h_lawyer_cell_two" name="h_lawyer_cell_two" id="h_lawyer_cell_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_email_one }}" type="email" id="h_lawyer_email_one" name="h_lawyer_email_one" id="h_lawyer_email_one" class="form-control valid" required="">
                                                    </div>
                                	            </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                            	                        <input value="{{ $data->h_lawyer_email_two }}" type="email" id="h_lawyer_email_two" name="h_lawyer_email_two" id="h_lawyer_email_two" class="form-control valid">
                                                    </div>
                                	            </div>
                                            </div>
