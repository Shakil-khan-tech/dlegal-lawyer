...
@section('title')
<title>Update Cases Activity</title>
@endsection
@section('lawyer-content')

<form action="{{ route('lawyer.litigation.case.activity.update',$activity->id) }}" method="POST">
      @csrf
      {{--<input type="hidden" value="{{ $cases->id }}" name="cases_id">--}}
      
  <div class="card shadow mb-3 ">
    <div class="card-header_show py-2" style="margin-bottom: 0px !important;">
      <h4 style="color: #2c9faf;margin-bottom:0;padding-bottom:0;" class="font-weight-bold">Update Case Activity Log</h4>
