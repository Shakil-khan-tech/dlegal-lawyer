                  ...
                  <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="district_id" id="name" class="form-control" required readonly>
                                ...
                                <option  value="{{ $row->id }}" {{ $data->district_id == $row->id ? 'selected' : '' }}>
                                    {{ $row->district_name }}
                                </option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="thana_name" value="{{ $data->thana_name }}" required readonly >
                        </div>
                                <div class="form-group">
                                    <label for="delete_status">Status</label>
                                    <select name="delete_status" id="delete_status" class="form-control" required readonly>
                        ...
                        <div class="d-flex justify-content-between">
                          ...
                          <a class="btn btn-info" href="{{ route('admin.police-station.index') }}" >Back</a>
                          <a href="{{ route('admin.police-station.edit',$data->id) }}" class="btn btn-success" ><i class="fas fa-edit"></i></a>
                        </div>
