              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="division_id" id="name" class="form-control" required readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="district_name" value="{{ $data->district_name }}" required readonly>
                                    </div>
                              
                                <div class="form-group">
                                    <label for="delete_status">Status</label>
                                    <select name="delete_status" id="delete_status" class="form-control" readonly>
                        ...
                        <div class="d-flex justify-content-between">
                          ...
                          <a href="{{ route('admin.district.edit',$data->id) }}" class="btn btn-success" ><i class="fas fa-edit"></i></a>
                        </div>
                  </div>
              </div>
          </div>
