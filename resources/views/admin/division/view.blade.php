              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="division_name" value="{{ $data->division_name }}" readonly>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between">
                          ...
                          <a class="btn btn-info" href="{{ route('admin.division.index') }}" >Back</a>
                          <a href="{{ route('admin.division.edit',$data->id) }}" class="btn btn-success" ><i class="fas fa-edit"></i></a>
                        </div>
                  </div>
              </div>
          </div>
