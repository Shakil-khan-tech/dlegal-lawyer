          ...
          <div class="col-md-6 m-auto">
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('admin.division.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        
                                <div class="form-group">
                                    <label for="division_name">Division Name</label>
                                    <input type="text" class="form-control" name="division_name" value="{{ $data->division_name }}" required>
                                </div>
                                <div class="form-group">
