              ...
              <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <div class="d-flex d-flex justify-content-between">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800"><a href="{{ route('admin.court.index') }}" class="btn btn-primary"><i class="fas fa-list" aria-hidden="true"></i> All Case Courts</a></h1>
                    </div>
                  </div>
                  <div class="card-body">
  
                      <form action="{{ route('admin.court.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                          @csrf
                        @method('put')
                        <div class="form-group">
                            ...
                            <select name="case_class" id="name" class="form-control" required >
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="all_district" id="all_district" class="form-control" required>
